...
#Initialize a hash to allow lookup of a codon to get the
...
# Delete the GTT entry from the hash.
delete $codonTranslation('GTT');
#Lookup the amino acid for codon GTT. 
print $codonTranslation{'GTT'},"\n"; 
#output is V
